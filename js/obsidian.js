...
(() => {
  setTimeout(() => {
    var logoHref = document.querySelector('.logo > .image-logo'),
      link = document.querySelector("#copyright > a[href='http://hexo.io/']"),
      name = document.querySelector('#copyright > .gradient-text');

    console.log(link, name);
    logoHref.innerText = 'JsRicardo';
    link.href = 'https://github.com/JsRicardo';
    link.innerText = 'JsRicardo';
    name.innerText = 'JsRicardo';
  }, 1000)
})()
$(function () {
  initialMathJax();
